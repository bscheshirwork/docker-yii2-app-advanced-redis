...
cd /home/dev/projects/docker-yii2-app-advanced-redis/php-data
git checkout master 
```
...
```sh
for i in backend common console frontend; do for j in main-local.php params-local.php; do mkdir -p /home/dev/projects/docker-yii2-app-advanced-redis_config/php-data/$i/config; cp -p /home/dev/projects/docker-yii2-app-advanced-redis/php-data/$i/config/$j /home/dev/projects/docker-yii2-app-advanced-redis_config/php-data/$i/config/$j; done; done;
```
...
```sh
for i in backend common console frontend; do for j in "main-local.php" "params-local.php"; do scp /home/dev/projects/docker-yii2-app-advanced-redis/php-data/$i/config/$j dev@host:/home/dev/projects/docker-yii2-app-advanced-redis/php-data/$i/config/$j; done; done
```

Восстановление (настроек "как на сервере"), соответственно, обратное
```sh
for i in backend common console frontend; do for j in main-local.php params-local.php test-local.php; do sudo cp -p /home/dev/projects/docker-yii2-app-advanced-redis_config/php-data/$i/config/$j /home/dev/projects/docker-yii2-app-advanced-redis/php-data/$i/config/$j; done; done;
```
...
git --git-dir /home/dev/projects/docker-yii2-app-advanced-redis/php-data/.git pull
```
